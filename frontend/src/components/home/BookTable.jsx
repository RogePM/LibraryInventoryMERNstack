            ...
            <tbody>
                {books.map((book, index) => (
                    <tr key={book._id} className='h-8'>
                        <td className='border-slate-700 rounded-md text-center'>{index + 1}</td>
                        <td className='border-slate-700 rounded-md text-center'>{book.title}</td>
                        <td className='border-slate-700 rounded-md text-center max-md:hidden'>{book.author}</td>
                        <td className='border-slate-700 rounded-md text-center max-md:hidden'>{book.year}</td>
